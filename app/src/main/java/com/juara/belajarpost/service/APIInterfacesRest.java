package com.juara.belajarpost.service;
...
public interface APIInterfacesRest {
    ...
    @FormUrlEncoded
    @POST("tbl_user_cv/add")
    Call<ResultModel> sendUser(@Field("nama") String nama, @Field("alamat") String alamat,@Field("no_telepon") String no_telepon,@Field("foto") String foto);
